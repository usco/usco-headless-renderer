...
if (args.length > 0) {
  (function () {
    ...
    // setup regl
    var regl = require('regl')(gl, (width, height));
    ...
    (0, _entityPrep2.default)(parsedData$, regl).forEach(function (entity) {
      ...
      camera = Object.assign({}, camera, (0, _uscoCameraUtils.computeCameraToFitBounds)({ camera: camera, bounds: entity.bounds, transforms: entity.transforms }));
